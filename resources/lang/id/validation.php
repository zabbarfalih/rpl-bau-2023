...
return [
    ...
    */
    ...
    "are_you_sure_you_want_to_delete_member" =>
        "Apakah kamu yakin ingin menghapus anggota tim ini?",
    ...
    "if_you_delete_team_all_data_will_be_deleted" =>
        "Jika Anda memilih untuk menghapus tim, semua data akan dihapus secara permanen.",
    ...
    "looks_like_you_are_not_part_of_team" =>
        "Sepertinya Anda bukan bagian dari tim mana pun!",
    ...
    "not_eligible_based_on_current_members_teams" =>
        "Anda tidak memenuhi syarat untuk paket ini berdasarkan jumlah tim/anggota tim Anda saat ini.",
    ...
    "plan_allows_no_more_teams" =>
        "Paket Anda saat ini tidak mengijinkan Anda membuat lebih banyak tim",
    "please_upgrade_to_add_more_members" =>
        "Tingkatkan paket langganan Anda untuk membuat lebih banyak anggota tim.",
    "please_upgrade_to_create_more_teams" =>
        "Tingkatkan paket langganan Anda untuk membuat lebih banyak tim.",
    ...
    "slug_input_explanation" =>
        "Slug ini digunakan untuk mengidentifikasi tim Anda di URL.",
    "starts_with" =>
    ...
    "team_trial_will_expire_on" =>
        "Masa percobaan tim akan berakhir pada :date.",
    "teams" => "Tim",
