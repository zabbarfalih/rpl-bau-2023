    ...
    <section class="section draft-pengajuan bg-white">
        <div class="row">
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                <h3 class="card-title text-center fw-bold fs-3">Daftar Pengajuan</h3>
                ...
                <table class="table table-hover datatable" id="table-bau">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">28 Agustus 2023</td>
                      <td class="text-center">
                        <span class="badge rounded-pill bg-warning text-dark">Menunggu Persetujuan</span>
                      </td>
                      <td>
                        <button type="button" class="btn btn-info btn-sm rounded-pill">Details</button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
