                        ...
                        <div class="card-body pt-3">
                          ...
                          <div class="tab-content pt-2">
                            ...
                            >
                              ...
                              <div class="row">
                                <div class="col-lg-3 col-md-4 label">
                                  Total Transpor Per Hari
                                </div>
                                <div class="col-lg-9 col-md-8">
                                  <p>Rp. {{ number_format($spj->total_transpor_per_hari, 2, ',', '.') }}
                                  </p>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8">
                                  <p>Rp. {{ number_format($spj->total_jumlah_kegiatan, 2, ',', '.') }}
                                  </p>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-9 col-md-8">
                                  <p>Rp. {{ number_format($spj->total_jumlah_yang_dibayarkan, 2, ',', '.') }}
                                  </p>
                                </div>
                              </div>
                              @endif
                ...
                <div class="activity">
                  ...
                  <div class="activity-item d-flex" id="tahap3">
                    ...
                    <div class="activity-content">
                      ...
                      <div class="finish">
                        <div class="download">
                          <a href="{{ url('/dashboard/tim-keuangan/konfirmasi-spjtr/download-spj-pdf/' . $spj->id) }}" target="_blank" onclick=" @if($spj->status !== 'Selesai') return false; @endif"><button type="button" class="btn btn-primary @if($spj->status !== 'Selesai') disabled @endif">Cetak</button></a>
                        </div>
                      </div>
                    </div>
                  </div>
