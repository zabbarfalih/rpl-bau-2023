        ...
        <div class="col-lg-12">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('pengecekansurtug.update', ['id' => $detailPengecekanSuratTugas->id]) }}" enctype="multipart/form-data">
                    ...
                    <script>
                        // Ambil elemen input tanggal_ttd
                        var tanggalTtd = document.getElementById('tanggal_ttd');
                        ...
                        // Set tanggal hari ini sebagai nilai minimum pada input tanggal_ttd
                        tanggalTtd.setAttribute('min', today);
                    </script>
