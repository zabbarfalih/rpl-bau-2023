                ...
                <div class="col-lg-12">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <form class="font-form fw-bold" method="POST" action="{{ route('submit-form') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <select id="inputNamaUnit" class="form-select font-form" name="jenisIzin">
                              <option value="Tidak Hadir" selected>Izin Tidak Hadir</option>
                            </select>
                          </div>
                        </div>
